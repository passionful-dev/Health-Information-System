<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_EntryUser.master" AutoEventWireup="true" CodeFile="Patient_EntryUserMaster.aspx.cs" Inherits="Patient_EntryUserMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="Panel2" runat="server">
        <table class="auto-style1">
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="~/Patient_Report_EntryUserMaster.aspx" CssClass="link">REPORT</asp:HyperLink>
                    &nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
            <tr>
                <td style="text-align: center">
                    <asp:HyperLink ID="HyperLink9" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/Patient_EntryUserMaster.aspx">View Patient Records</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
