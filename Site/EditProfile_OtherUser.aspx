<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" UnobtrusiveValidationMode="none" AutoEventWireup="true" CodeFile="EditProfile_OtherUser.aspx.cs" Inherits="EditProfile_OtherUser" %>
...
<asp:Panel ID="Panel2" runat="server">
        <table align="center">
            ...
            <tr>
                <td colspan="3" style="text-align: center">
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" style="font-size: large" Text="Edit Profile"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td style="margin-left: 40px">
                    <asp:TextBox ID="txtboxCountry" placeholder="Country" runat="server"></asp:TextBox>
                </td>
                <td class="auto-style2">&nbsp;</td>
            </tr>
            <tr>
