<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" AutoEventWireup="true" CodeFile="Patient_Report_OtherUserMaster.aspx.cs" Inherits="Patient_Report_OtherUserMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        <tr>
            <td><asp:HyperLink ID="HyperLink13" runat="server" CssClass="link" NavigateUrl="~/Patient_OtherUserMaster.aspx">VIEW</asp:HyperLink>
                </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: center">
                    <asp:HyperLink ID="HyperLink14" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/Patient_Report_OtherUserMaster.aspx">Patient Report</asp:HyperLink>
                </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
