<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_EntryUser.master" UnobtrusiveValidationMode="none" MaintainScrollPositionOnPostBack="true" AutoEventWireup="true" CodeFile="EditProfile_EntryUser.aspx.cs" Inherits="EditProfile_EntryUser" %>
    ...
    <asp:Panel ID="Panel2" runat="server">
        <table class="auto-style1" align="center">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Button ID="btnOk_Email" runat="server" Text="Ok" Visible="False" ValidationGroup="Email" OnClick="btnOk_Email_Click" />
                </td>
                <td>
            ...
            <tr>
                <td style="margin-left: 120px" class="separator">
                    ...
                    <asp:Label ID="lblDesignationLabel" runat="server" Visible="False">Designation</asp:Label>
                </td>
                <td colspan="2" class="separator">
                    <asp:LinkButton ID="lnkbtnEdit_Designation" runat="server" CausesValidation="False" OnClick="lnkbtnEdit_Designation_Click" CssClass="link">Edit Designation</asp:LinkButton>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td style="margin-left: 120px">
                    <asp:TextBox ID="txtboxDesignation" runat="server" placeholder="Designation" Visible="False" MaxLength="29"></asp:TextBox>
                </td>
                <td colspan="2">
                    <asp:Button ID="btnOk_Designation" runat="server" OnClick="btnOk_Designation_Click" Text="Ok" ValidationGroup="Desig" Visible="False" />
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="ReqFieldVald_Email1" runat="server" ControlToValidate="txtboxDesignation" ErrorMessage="Designation required!" style="color: #FF3300" ValidationGroup="Desig">Designation required!</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtboxDesignation" Display="Dynamic" ErrorMessage="Designation provided is not in the correct format!" style="color: #FF0000" ValidationExpression="/^[A-Za-z ]*|[a-zA-Z ]*|[a-z ]*|[A-Z ]*$/">Not in correct format!</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td style="margin-left: 120px">&nbsp;</td>
