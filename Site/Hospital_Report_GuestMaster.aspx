<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Guest.master" AutoEventWireup="true" CodeFile="Hospital_Report_GuestMaster.aspx.cs" Inherits="Hospital_Report_GuestMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="Panel1" runat="server">
        <table class="auto-style1">
            <tr>
                <td colspan="2">
                    <asp:HyperLink ID="HyperLink13" runat="server" CssClass="link" NavigateUrl="~/Hospital_GuestMaster.aspx">VIEW</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: center">
                    <asp:HyperLink ID="HyperLink14" runat="server" Font-Bold="True" Font-Size="Large" CssClass="headerlink" NavigateUrl="~/Hospital_Report_GuestMaster.aspx">Hospital Report</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
