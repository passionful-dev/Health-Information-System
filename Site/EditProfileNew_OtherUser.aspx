<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" UnobtrusiveValidationMode="none" AutoEventWireup="true" MaintainScrollPositionOnPostBack="true" CodeFile="EditProfileNew_OtherUser.aspx.cs" Inherits="EditProfileNew_OtherUser" %>
        ...
        <table class="auto-style1" align="center">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtboxFirstName" Display="Dynamic" ErrorMessage="First name provided is not in the correct format!" style="color: #FF0000" ValidationExpression="/^[A-Za-z]*[ ]*|[a-zA-Z]*[ ]*|[a-z]*[ ]*|[A-Z]*[ ]*$/">Not in correct format!</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td class="auto-style3">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtboxLastName" Display="Dynamic" ErrorMessage="Last name provided is not in the correct format!" style="color: #FF0000" ValidationExpression="/^[A-Za-z]*[ ]*|[a-zA-Z]*[ ]*|[a-z]*[ ]*|[A-Z]*[ ]*$/">Not in correct format!</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
