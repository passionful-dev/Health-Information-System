<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" AutoEventWireup="true" CodeFile="Log_PatientLog_OtherUserMaster.aspx.cs" Inherits="Log_PatientLog_OtherUserMaster" %>
    ...
    <table class="auto-style1">
        <tr>
            <td colspan="2" style="text-align: left">
                    <asp:HyperLink ID="HyperLink13" runat="server" CssClass="link" NavigateUrl="~/Log_Patient_OtherUserMaster.aspx">PATIENT LIST</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:HyperLink ID="HyperLink9" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/Log_PatientLog_OtherUserMaster.aspx">Patient Log </asp:HyperLink>
            </td>
        </tr>
        <tr>
