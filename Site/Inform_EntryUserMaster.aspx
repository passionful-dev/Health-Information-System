<%@ Page Title="" Language="C#" UnobtrusiveValidationMode="none" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPage_EntryUser.master" AutoEventWireup="true" CodeFile="Inform_EntryUserMaster.aspx.cs" Inherits="Inform_EntryUserMaster" %>
    ...
    <asp:Panel ID="Panel2" runat="server">
        <table class="auto-style1" align="center">
            ...
            <tr>
                ...
                <asp:ValidationSummary ID="ValidationSummary1" runat="server" Style="color: #FF3300" ValidationGroup="Message" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="dropdownlistUsername" ErrorMessage="Username required!" Style="color: #FF3300" ValidationGroup="Message">*</asp:RequiredFieldValidator>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtboxMessage" ErrorMessage="Message required!" Style="color: #FF3300" ValidationGroup="Message">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td>
                    <asp:Button ID="btnSend" runat="server" OnClick="btnSend_Click" Text="Send" Width="70px" ValidationGroup="Message" />
                </td>
            </tr>
            <tr>
                <td>
