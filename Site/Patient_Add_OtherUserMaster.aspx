<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" UnobtrusiveValidationMode="none" MaintainScrollPositionOnPostBack="true" AutoEventWireup="true" CodeFile="Patient_Add_OtherUserMaster.aspx.cs" Inherits="Patient_Add_OtherUserMaster" %>
        ...
        <table align="center">
            <tr>
                <td colspan="3" style="text-align: left">
                    <asp:HyperLink ID="HyperLink10" runat="server" CssClass="link" NavigateUrl="~/Patient_OtherUserMaster.aspx">VIEW</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="text-align: center">
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" style="font-size: large" Text="Register Patient"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtboxMiddleName" placeholder="Middle Name" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtboxLastName" placeholder="Last Name" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>
                    ...
                    &nbsp; </td>
                <td>
                    <asp:TextBox ID="txtboxSecEmail" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label24" runat="server" Text="Date of Birth (dd/mm/yyyy)"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtboxSecContact" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtboxHouseAdd" placeholder="House Address" runat="server"></asp:TextBox>
                </td>
                <td style="margin-left: 40px">
                    <asp:TextBox ID="txtboxDistrict" placeholder="District" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtboxCity" placeholder="City" runat="server"></asp:TextBox>
                ...
                <td style="margin-left: 40px">
                    <asp:TextBox ID="txtboxCountry" placeholder="Country: Nepal by default" runat="server"></asp:TextBox>
                </td>
                <td class="auto-style2">&nbsp;</td>
            </tr>
            <tr>
