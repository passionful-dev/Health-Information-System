<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Patient.master" AutoEventWireup="true" CodeFile="Hospital_PatientMaster.aspx.cs" Inherits="Hospital_PatientMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="Panel2" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink13" runat="server" CssClass="link" NavigateUrl="~/Hospital_Report_PatientMaster.aspx">REPORT</asp:HyperLink>
                    &nbsp;&nbsp;</td>
            </tr>
            <tr>
                <td style="text-align: center">
                    <asp:HyperLink ID="HyperLink9" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/Hospital_PatientMaster.aspx">View Hospital Records</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
