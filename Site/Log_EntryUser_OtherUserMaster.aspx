<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" AutoEventWireup="true" CodeFile="Log_EntryUser_OtherUserMaster.aspx.cs" Inherits="Log_EntryUser_OtherUserMaster" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td style="text-align: center">
                    <asp:HyperLink ID="HyperLink9" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/Log_EntryUser_OtherUserMaster.aspx">View Entry User Records</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
