<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Patient.master" AutoEventWireup="true" CodeFile="Message_PatientMaster.aspx.cs" Inherits="Message_PatientMaster" %>
        ...
        <table align="center">
            ...
            <tr>
                <td style="text-align: center">
                    &nbsp;</td>
                <td style="text-align: center">
                    <asp:HyperLink ID="HyperLink9" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/Message_PatientMaster.aspx">Message</asp:HyperLink>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style5">&nbsp;
                    <asp:LinkButton ID="lnkbtn_NewMessage" runat="server" CssClass="link" OnClick="lnkbtn_NewMessage_Click" Visible="False">New</asp:LinkButton>
                </td>
                <td rowspan="8">
