<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_EntryUser.master" AutoEventWireup="true" CodeFile="Message_EntryUserMaster.aspx.cs" Inherits="Message_EntryUserMaster" %>
        ...
        <table align="center">
            ...
            <tr>
                <td style="text-align: center">
                    &nbsp;</td>
                <td style="text-align: center">
                    <asp:HyperLink ID="HyperLink9" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/Message_EntryUserMaster.aspx">Message</asp:HyperLink>
                </td>
            </tr>
            <tr>
