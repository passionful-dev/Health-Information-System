<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" AutoEventWireup="true" CodeFile="Home_OtherUser.aspx.cs" Inherits="Home_OtherUser" %>
            ...
            <td colspan="2">
                ...
                <asp:DataList ID="DataList1" runat="server" align="center" Width="700px">
                    ...
                    <ItemTemplate>
                        ...
                        <br />
                        &nbsp; Field:
                        <asp:Label ID="FieldChangedLabel" runat="server" Text='<%# Eval("FieldChanged") %>' />
                        <br />
                        &nbsp; Before:
                        <asp:Label ID="DataBeforeLabel" runat="server" Text='<%# Eval("DataBefore") %>' />
                        <br />
                        &nbsp; Later:
                        <asp:Label ID="DataLaterLabel" runat="server" Text='<%# Eval("DataLater") %>' />
                        <br />
<br />
                    </ItemTemplate>
                </asp:DataList>
