<%@ Page Title="" Language="C#" UnobtrusiveValidationMode="none" MaintainScrollPositionOnPostBack="true" MasterPageFile="~/MasterPage_OtherUser.master" AutoEventWireup="true" CodeFile="EntryUserForm_Add_OtherUserMaster.aspx.cs" Inherits="EntryUserForm_Add_OtherUserMaster" %>
        ...
        <table align="center">
            <tr>
                <td colspan="3" style="text-align: left">
                    <asp:HyperLink ID="HyperLink10" runat="server" CssClass="link" NavigateUrl="~/EntryUserForm_OtherUserMaster.aspx">VIEW</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="text-align: center">
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" style="font-size: large" Text="Register Entry User"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label26" runat="server" Text="Designation"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="Label27" runat="server" Text="Hospital"></asp:Label>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    <asp:TextBox ID="txtboxDesignation" runat="server" MaxLength="29"></asp:TextBox>
                    <asp:Label ID="lblUsernameAsterik0" runat="server" Text="*"></asp:Label>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="txtboxDesignation" ErrorMessage="Designation required!" style="color: #FF3300">*</asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtboxDesignation" Display="Dynamic" ErrorMessage="Designation provided is not in the correct format!" style="color: #FF0000" ValidationExpression="/^[A-Za-z ]*|[a-zA-Z ]*|[a-z ]*|[A-Z ]*$/">*</asp:RegularExpressionValidator>
                </td>
                <td>
                    <asp:DropDownList ID="dropdownlist_Hospital" runat="server">
                    </asp:DropDownList>
                    <asp:Label ID="lblEmailAsterik0" runat="server" Text="*"></asp:Label>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="dropdownlist_Hospital" ErrorMessage="Hospital required!" style="color: #FF3300">*</asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <%--<asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" SelectionMode="DayWeekMonth" Visible="False"></asp:Calendar>--%>
            ...
            <tr>
                ...
                <td style="margin-left: 40px">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ControlToValidate="txtboxDistrict" Display="Dynamic" ErrorMessage="District provided is not in the correct format!" style="color: #FF0000" ValidationExpression="/^[A-Za-z]*[ ]*|[a-zA-Z]*[ ]*|[a-z]*[ ]*|[A-Z]*[ ]*$/">*</asp:RegularExpressionValidator>
                </td>
                <td class="auto-style2">&nbsp;</td>
            </tr>
            <tr>
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server" ControlToValidate="txtboxCity" Display="Dynamic" ErrorMessage="City provided is not in the correct format!" style="color: #FF0000" ValidationExpression="/^[A-Za-z]*[ ]*|[a-zA-Z]*[ ]*|[a-z]*[ ]*|[A-Z]*[ ]*$/">*</asp:RegularExpressionValidator>
                </td>
                <td style="margin-left: 40px">
