<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" AutoEventWireup="true" CodeFile="Hospital_Report_OtherUserMaster.aspx.cs" Inherits="Hospital_Report_OtherUserMaster" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td colspan="2" style="text-align: center">
                    <asp:HyperLink ID="HyperLink14" runat="server" Font-Bold="True" Font-Size="Large" CssClass="headerlink" NavigateUrl="~/Hospital_Report_OtherUserMaster.aspx">Hospital Report</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
