<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_OtherUser.master" AutoEventWireup="true" CodeFile="EntryUserFrom_Report_OtherUserMaster.aspx.cs" Inherits="EntryUserFrom_Report_OtherUserMaster" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td colspan="2" style="text-align: center">
                    <asp:HyperLink ID="HyperLink14" runat="server" CssClass="headerlink" Font-Bold="True" Font-Size="Large" NavigateUrl="~/EntryUserFrom_Report_OtherUserMaster.aspx">Entry User Report</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td colspan="2" align="center">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="999px">
                        <LocalReport ReportPath="Report_EntryUser_OtherUserMaster.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="DataSet_EntryUserForm_Report_OtherUserMasterTableAdapters.DataTable1TableAdapter"></asp:ObjectDataSource>
                </td>
            </tr>
            <tr>
                <td>
